...
context = {
    ...
    'current_version': "enhancement/#77/private-modules",
    'version_slug': "enhancement-77-private-modules",
    ...
    'versions': [
        ("latest", "/en/latest/"),
        ("v0.2.2", "/en/v0.2.2/"),
        ("enhancement-77-private-modules", "/en/enhancement-77-private-modules/"),
    ],
    'downloads': [
        ("pdf", "//scenario-testing-framework.readthedocs.io/_/downloads/en/enhancement-77-private-modules/pdf/"),
        ("html", "//scenario-testing-framework.readthedocs.io/_/downloads/en/enhancement-77-private-modules/htmlzip/"),
        ("epub", "//scenario-testing-framework.readthedocs.io/_/downloads/en/enhancement-77-private-modules/epub/"),
    ],
    'subprojects': [
    ],
    'slug': 'scenario-testing-framework',
    'name': u'scenario-testing-framework',
    'rtd_language': u'en',
    'programming_language': u'py',
    'canonical_url': 'https://scenario-testing-framework.readthedocs.io/en/v0.2.2/',
    'analytics_code': 'None',
    'single_version': False,
    'conf_py_path': '/tools/conf/sphinx/',
    'api_host': 'https://readthedocs.org',
    'github_user': 'alxroyer',
    'proxied_api_host': '/_',
    'github_repo': 'scenario',
    'github_version': 'enhancement/#77/private-modules',
    'display_github': True,
    'bitbucket_user': 'None',
    'bitbucket_repo': 'None',
    'bitbucket_version': 'enhancement/#77/private-modules',
    'display_bitbucket': False,
    'gitlab_user': 'None',
    'gitlab_repo': 'None',
    'gitlab_version': 'enhancement/#77/private-modules',
...
if 'branch' == 'external':
    ...
    readthedocs_build_url = 'https://readthedocs.org/projects/scenario-testing-framework/builds/20121949/'
