...
TEST_PATH = MAIN_PATH / "test"  # type: scenario.Path
TEST_CASES_PATH = MAIN_PATH / "test" / "cases"  # type: scenario.Path
TEST_DATA_PATH = MAIN_PATH / "test" / "data"  # type: scenario.Path
TEST_SRC_PATH = MAIN_PATH / "test" / "src"  # type: scenario.Path
TEST_SRC_DATA_PATH = MAIN_PATH / "test" / "src" / "scenario" / "test" / "_data.py"  # type: scenario.Path
TEST_TOOLS_PATH = MAIN_PATH / "test" / "tools"  # type: scenario.Path
TOOLS_PATH = MAIN_PATH / "tools"  # type: scenario.Path
TOOLS_CONF_PATH = MAIN_PATH / "tools" / "conf"  # type: scenario.Path
TOOLS_LIB_PATH = MAIN_PATH / "tools" / "lib"  # type: scenario.Path
TOOLS_SRC_PATH = MAIN_PATH / "tools" / "src"  # type: scenario.Path
UTILS_SRC_PATH = MAIN_PATH / "utils" / "src"  # type: scenario.Path
