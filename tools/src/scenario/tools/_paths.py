...
DOWNSTREAM_TRACEABILITY_SCHEMA_PATH = ROOT_SCENARIO_PATH / scenario.ReqTraceability.Downstream.JSON_SCHEMA_SUBPATH  # type: scenario.Path
REQ_DB_SCHEMA_PATH = ROOT_SCENARIO_PATH / scenario.ReqDatabase.JSON_SCHEMA_SUBPATH  # type: scenario.Path
SCENARIO_REPORT_SCHEMA_PATH = ROOT_SCENARIO_PATH / scenario.report.JSON_SCHEMA_SUBPATH  # type: scenario.Path
UPSTREAM_TRACEABILITY_SCHEMA_PATH = ROOT_SCENARIO_PATH / scenario.ReqTraceability.Upstream.JSON_SCHEMA_SUBPATH  # type: scenario.Path
