...
OPTIMIZED_PATHS = [
    ...
    _paths.SRC_PATH / "scenario" / "_assertionhelpers.py",
    _paths.SRC_PATH / "scenario" / "_campaignargs.py",
    _paths.SRC_PATH / "scenario" / "_campaignlogging.py",
    _paths.SRC_PATH / "scenario" / "_campaignreport.py",
    ...
    _paths.SRC_PATH / "scenario" / "_fastpath.py",
    ...
    _paths.SRC_PATH / "scenario" / "_loggingservice.py",
    ...
    _paths.SRC_PATH / "scenario" / "_scenarioreport.py",
