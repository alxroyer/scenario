...
class CheckImports:
    ...
    class Args(scenario.Args):
        def __init__(self):  # type: (...) -> None
            ...
            self._import_group = self._arg_parser.add_argument_group("Import checking")  # Type `argparse._ArgumentGroup` not available, let default typing.

            self._import_group.add_argument(
        ...
        @property
        def paths(self):  # type: () -> typing.Sequence[scenario.Path]
            return [scenario.Path(_path) for _path in self._args.paths]
