...
class CheckFullScenarioReport(_ScenarioReportFileVerificationStepImpl):
    ...
    def _checkscenario(
            ...
            json_scenario_ref,  # type: scenario.types.JsonDict
    ):  # type: (...) -> None
        ...
        _step_definitions_ref = self._assertjsonref(json_scenario_ref, "steps", type=list)  # type: typing.List[scenario.types.JsonDict]
    ...
    def _checkstepdefinition(
            ...
            json_step_definition_ref,  # type: scenario.types.JsonDict
    ):  # type: (...) -> None
        if self.doexecute():
        ...
        _executions_ref = self._assertjsonref(json_step_definition_ref, "executions", type=list)  # type: typing.List[scenario.types.JsonDict]
        ...
        _action_result_definitions_ref = self._assertjsonref(json_step_definition_ref, "actions-results", type=list) \
            # type: typing.List[scenario.types.JsonDict]
    ...
    def _checkstepexecution(
            ...
            json_step_execution_ref,  # type: scenario.types.JsonDict
    ):  # type: (...) -> None
        if self.doexecute():
    ...
    def _checkactionresultdefinition(
            ...
            json_action_result_definition_ref,  # type: scenario.types.JsonDict
    ):  # type: (...) -> None
        if self.doexecute():
    ...
    def _checkactionresultexecution(
            ...
            json_action_result_execution_ref,  # type: scenario.types.JsonDict
    ):  # type: (...) -> None
        if self.doexecute():
        ...
        _json_subscenarios_ref = self._assertjsonref(json_action_result_execution_ref, "subscenarios", type=list)  # type: typing.List[scenario.types.JsonDict]
        ...
        for _subscenario_index in range(len(_json_subscenarios_ref)):  # type: int
            _json_subscenario_ref = _json_subscenarios_ref[_subscenario_index]  # type: scenario.types.JsonDict
    ...
    def _checktimes(
            self,
            json_time,  # type: scenario.types.JsonDict
            json_time_ref,  # type: scenario.types.JsonDict
    ):  # type: (...) -> None
    ...
    def _checkerrors(
            self,
            json_obj,  # type: scenario.types.JsonDict
            json_obj_ref,  # type: scenario.types.JsonDict
            jsonpath,  # type: str
    ):  # type: (...) -> None
        _errors_ref = self._assertjsonref(json_obj_ref, jsonpath, type=list)  # type: typing.List[scenario.types.JsonDict]
    ...
    def _assertjsonref(
            self,
            json_ref,  # type: scenario.types.JsonDict
