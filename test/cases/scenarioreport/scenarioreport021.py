...
class ScenarioReport021(scenario.test.TestCase):
    ...
    def __init__(self):  # type: (...) -> None
        ...
        scenario.test.TestCase.__init__(
            self,
            title="Scenario report failing scenario --doc-only",
            description=(
                "Check the scenario report is generated as expected for a failing scenario, "
