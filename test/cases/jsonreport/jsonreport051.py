...
class JsonReport051(scenario.test.TestCase):
    ...
    def __init__(self):  # type: (...) -> None
        scenario.test.TestCase.__init__(
            ...
            objective="Check the JSON report is generated as expected for a scenario with known issues executed with the --doc-only option set.",
            features=[scenario.test.features.SCENARIO_REPORT, scenario.test.features.KNOWN_ISSUES, scenario.test.features.DOC_ONLY],
        )
